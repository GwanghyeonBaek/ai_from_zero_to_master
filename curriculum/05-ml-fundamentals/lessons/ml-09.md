# ML-09: Tree models and ensemble intuition

## Definition
Core concept: **Tree models and ensemble intuition** is required to build leakage-safe and decision-relevant ML systems.
...
## Worked Example
DecisionTree(max_depth=None) overfits train set; RandomForest improves validation stability.
