# ML-04: Baseline models and benchmark logic

## Definition
Core concept: **Baseline models and benchmark logic** is required to build leakage-safe and decision-relevant ML systems.
...
## Worked Example
Compare DummyClassifier(strategy="most_frequent") vs LogisticRegression as minimum uplift check.
