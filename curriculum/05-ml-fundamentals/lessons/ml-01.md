# ML-01: Problem framing and target definition

## Definition
Core concept: **Problem framing and target definition** is required to build leakage-safe and decision-relevant ML systems.
...
## Worked Example
Predict next-30-day churn (binary) from activity in last 14 days; do not use post-churn signals.
